...
export default function AddCourse({ courseModules }: AddCourseProps) {
  ...
  const isNewLesson = selectedModule && newLesson && isContentValid && !isExistingLesson;
  const isExistingLessonValid = selectedModule && selectedLessonTitle && isContentValid && isExistingLesson && editable;

  const isFormFilled = (isNewLesson && editable) || isExistingLessonValid;

  useEffect(() => {
    // Set disableEdit state based on the conditions...
  ...
  function stripHtmlTags(content: string): string {
    return content.replace(/<p><\/p>/g, "")
      ...
      .replace(/<pre class="bg-stone-800 text-white p-2 rounded-lg mx-2 my-2"><\/pre>/g, "")
      .replace(/<code><\/code>/g, "")
      .replace(/<a target="_blank" rel="noopener noreferrer nofollow" class="text-blue-600 underline" href=""><\/a>/g, "")
      .replace(/<table class="border border-collapse px-3 py-1 w-full overflow-scroll" style="minWidth: 100px"><colgroup><col><\/col><col><\/col><col><\/col><col><\/col><\/colgroup><tbody><tr class="border border-collapse px-3 py-1"><th class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/th><th class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/th><th class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/th><th class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/th><\/tr><tr class="border border-collapse px-3 py-1"><td class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/td><td class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/td><td class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/td><td class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/td><\/tr><tr class="border border-collapse px-3 py-1"><td class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/td><td class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/td><td class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/td><td class="border border-collapse px-3 py-1" colspan="1" rowspan="1"><p><\/p><\/td><\/tr><\/tbody><\/table>/g, "")
      .trim();
  }
