        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            {isHomeworkCompleted ? (
              <DialogHeader>
                <DialogDescription>
                  Homework Already Submitted for this lesson
                </DialogDescription>
              </DialogHeader>
            ) : (
              <div>
                <DialogHeader>
                  <DialogTitle className="text-left">
                    Submit Homework! {student?.id}
                  </DialogTitle>
                  <h2 className="text-left py-1">
                    {courseModules && courseModules[currentModuleIndex]
                      ? courseModules[currentModuleIndex].lessons[
                          currentLessonIndex
                        ]?.title || ""
                      : ""}
                  </h2>
                  <DialogDescription className="text-left py-1">
                    Submit your homework as may you like as text, link or
                    document...
                  </DialogDescription>
                </DialogHeader>
